...
\def\{{= macroName}}{{| argList, '', ctmFormalArgs, argTemplate }}{%
  \directlua{%
...
function contests.createTraceMacro(macroName, numArgs, argType)
  local argTemplate = 'ctmTexFormalArgs'
  if argType == 'context' then
    argTemplate = 'ctmContextFormalArgs'
  end
  local argList = { }
  for argNum = 1, numArgs, 1 do
    tInsert(argList, argNum)
  end
  local result = 
    templates.ctmMain(macroName, argList, argType, argTemplate)
