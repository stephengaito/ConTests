...
function reportCAssertion(
  ...
  if 0 < #curCase.shouldFail then
    io.stdout:write('reportCAssertion shouldFail\n')
    io.stdout:write(prettyPrint(theCondition)..'\n')
    io.stdout:write(prettyPrint(aMessage)..'\n')
    io.stdout:write(prettyPrint(theReason)..'\n')
    io.stdout:write(prettyPrint(curCase.shouldFail)..'\n')
